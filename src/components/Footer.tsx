      ...
      <div className="container mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
            Plataforma de engajamento com o cliente. Um fork do projeto Chatwoot, adaptado as necessidades do mercado brasileiro. Uma alternativa ao Intercom, Zendesk e Salesforce Service Cloud.
          </p>
